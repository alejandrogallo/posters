...
real UNEXCITED_VALUE_x   = 606.306   ;
string UNEXCITED_LABEL_x    = "$x$   ";
real UNEXCITED_VALUE_y   = 606.306   ;
string UNEXCITED_LABEL_y    = "$y$   ";
real UNEXCITED_VALUE_z   = -1212.612   ;
string UNEXCITED_LABEL_z    = "$z$   ";

string EXCITED_TITLE = "C";
real EXCITED_VALUE_x     = 335.724666667     ;
string EXCITED_LABEL_x      = "$x$     ";
real EXCITED_VALUE_y     = 335.724666667     ;
string EXCITED_LABEL_y      = "$y$     ";
real EXCITED_VALUE_z     = -671.449333333     ;
