...
string UNEXCITED_TITLE = "\underline{State A}";
...
string EXCITED_TITLE = "\underline{State C}";
...
//draw states titles
//label(UNEXCITED_TITLE, (25/2,90), black, Fill(white));
//label(EXCITED_TITLE, (25+5+25/2,90), black, Fill(white));
