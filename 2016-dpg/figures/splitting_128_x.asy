...
unex_state2.label_orientation = "r";
...
draw_distance(CENTER, unex_state2, units="MHz", lbl_x_offset=-15, energy_format=ENERGY_FORMAT);
...
draw_distance(CENTER, ex_state1, units="MHz", lbl_x_offset=-0, energy_format=ENERGY_FORMAT);
draw_distance(CENTER, ex_state2, units="MHz", lbl_x_offset=15, energy_format=ENERGY_FORMAT);
